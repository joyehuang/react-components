...
export const componentRegistry: ComponentMeta[] = [
  {
    ...
    name: "Credit Card",
    summary:
      "Interactive 3D bank card with tilt, glare, keyboard support, and controlled flip mode.",
    category: "Cards",
    status: "stable",
...
/>`,
    ...
    props: [
      {
        ...
        description: "Card number text.",
      },
      {
        name: "cardholder",
        type: "string",
        defaultValue: "JOHN DOE",
        description: "Cardholder text on the front face.",
      },
      {
        name: "expires",
        type: "string",
      ...
      },
      {
        ...
        type: "string",
        defaultValue: "123",
        description: "CVV number on the back face.",
      },
      {
        name: "maxTilt",
        type: "number",
        defaultValue: "14",
        description: "Maximum pointer tilt amount in degrees.",
      },
      {
        name: "width",
        type: "number | string",
        defaultValue: "480",
        description: "Card width via CSS size token.",
      },
      {
        name: "clickToFlip",
        type: "boolean",
        defaultValue: "true",
        description: "Enables click and keyboard flip interaction.",
      },
      {
        name: "flipped",
        type: "boolean",
        description: "Controlled flipped state when provided.",
      },
    ],
  ...
  },
  {
    ...
    name: "Simple Graph",
    summary:
      "Animated line graph with smooth path drawing, hover tooltip, and configurable visual tokens.",
...
/>`,
    ...
    props: [
      {
        name: "points",
        type: "Array<{ id; label; value }>",
        description: "Data points rendered along the chart axis.",
      },
      {
        name: "height",
        type: "number | string",
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: "true",
        description: "Toggles horizontal guide lines.",
      },
      {
        name: "showArea",
        type: "boolean",
        defaultValue: "false",
        description: "Shows gradient area fill under the line.",
      },
      {
        name: "animationDurationMs",
        type: "number",
        defaultValue: "1400",
        description: "Line draw animation duration.",
      },
      {
        name: "colors",
        type: "Partial<SimpleGraphColorOverrides>",
  ...
  },
  {
    ...
    name: "Neon Network",
    summary:
      "Center-node neon network animation with start/restart controls and CSS-variable-driven theming.",
...
/>`,
    ...
    props: [
      {
        ...
        type: "boolean",
        defaultValue: "true",
        description: "Shows the start / restart button.",
      },
      {
        name: "autoStart",
        type: "boolean",
        defaultValue: "false",
        description: "Auto-runs animation on mount.",
      },
      {
        name: "fillDurationMs",
        type: "number",
        defaultValue: "2200",
        description: "Core line fill duration.",
      },
      {
        name: "glowDurationMs",
        type: "number",
        description: "Glow line fill duration.",
      },
      {
        name: "maxWidth",
        type: "number | string",
        defaultValue: "1024",
        description: "Maximum stage width.",
      },
      {
        name: "colors",
        type: "Partial<NeonNetworkColorOverrides>",
        description: "Token overrides for lines/nodes/button.",
      },
      {
        name: "onComplete",
        type: "() => void",
        description: "Called after one animation cycle completes.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "Scroll-driven 3D cylindrical headline effect powered by GSAP ScrollTrigger.",
...
/>`,
    ...
    installNotes: [
      "Keep gsap in dependencies: pnpm add gsap.",
      "Copy TSX and CSS files to src/components/ui.",
    ],
    props: [
      {
        name: "lines",
        type: "string[]",
        description: "Uppercase text lines rendered on the cylinder.",
      },
      {
        name: "stickyTopOffset",
        type: "string",
        defaultValue: "0px",
        description: "Sticky top offset for pinned stage.",
      },
      {
        name: "sectionMinHeight",
        type: "string",
        defaultValue: "240vh",
        description: "Scroll section height.",
      },
      {
        name: "radius",
        type: "number",
        defaultValue: "330",
        description: "Cylinder radius used in transform math.",
      },
      {
        name: "angleStep",
        type: "number",
        defaultValue: "0.26",
        description: "Angle spacing between text lines.",
      },
      {
        name: "rollStartAngle",
        type: "number",
      ...
      },
      {
        ...
        type: "number",
        defaultValue: "-1.35",
        description: "Final roll angle in radians.",
      },
    ],
  ...
  },
  {
    ...
    name: "Text Scatter",
    summary:
      "Pointer-reactive spring text displacement effect with per-character physics updates.",
    category: "Text Motion",
    status: "stable",
  ...
  },
  {
    ...
    summary:
      "Directional letter burst effect with bounded scatter distance and spring return.",
    category: "Text Motion",
    status: "stable",
...
/>`,
    ...
    installNotes: [
      "Copy TSX and CSS files.",
      "Tune triggerRadius and scatterHoldMs for your interaction style.",
    ],
    props: [
      {
        name: "text",
        type: "string",
        defaultValue: "Bounce Back.",
      ...
      },
      {
        ...
        type: "number",
        defaultValue: "78",
        description: "Pointer trigger radius per character.",
      },
      {
        name: "scatterHoldMs",
        type: "number",
        defaultValue: "1200",
        description: "How long characters stay exploded.",
      },
      {
        name: "targetScatterDistance",
        type: "number",
        defaultValue: "320",
        description: "Preferred outward travel distance.",
      },
      {
        name: "spring",
        type: "number",
        defaultValue: "0.06",
        description: "Spring force for returning letters.",
      },
      {
        name: "damping",
        type: "number",
        defaultValue: "0.86",
        description: "Velocity damping multiplier.",
      },
    ],
...
export const getComponentBySlug = (slug: string | undefined) =>
  slug ? componentBySlug.get(slug) : undefined;
