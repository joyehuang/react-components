...
import './App.css'
import { CreditCard, NeonNetwork, SimpleGraph, TextScatter, TextScatterBurst } from '@rc-lab/ui'
import Scroll3DHeadline from './components/Scroll3DHeadline'

type DemoTab = 'network' | 'simplegraph' | 'scroll3d' | 'textscatter' | 'textscatterburst' | 'creditcard'
